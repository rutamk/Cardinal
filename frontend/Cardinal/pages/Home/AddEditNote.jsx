...
const AddEditNote = ({
  ...
  return (
    <div className="relative">
      <button
        className="w-10 h-10 rounded-full flex items-center justify-center absolute -top-4 -right-4 overflow-hidden hover:bg-slate-100
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <div
          id="editor"
          className="text-sm text-slate-950 bg-slate-100 rounded p-2 dark:bg-neutral-800 dark:text-neutral-200"
      ...
      <button
        className="w-full text-sm bg-blue-500 text-white rounded my-1 hover:bg-blue-600 font-medium mt-7 p-3
