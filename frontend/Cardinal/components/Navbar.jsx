...
const Navbar = ({ userInfo, onSearchQuery, handleClearSearch }) => {
  ...
  return (
    <div className="bg-white grid grid-cols-1 sm:grid-cols-3 items-center h-fit sm:h-16 px-4 sm:px-6 py-2 drop-shadow select-none
     dark:bg-neutral-800 dark:text-neutral-200">
      <div className=' col-span-1 flex justify-center sm:justify-start'>
      <h2 className='text-lg sm:text-xl font-medium text-blue-500 py-2 sm:py-0 select-text
      dark:text-[#ffd84c]'>Cardinal</h2>
      </div>
